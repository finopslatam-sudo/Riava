...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const { access_token, business_name, system_prompt, tone, business_info, enable_scheduling, enable_quotes } = body as {
    access_token?: string
  ...
  if (
    ...
    business_info === undefined && enable_scheduling === undefined && enable_quotes === undefined
  ) {
  ...
  if (enable_quotes !== undefined) updates.enable_quotes = enable_quotes
